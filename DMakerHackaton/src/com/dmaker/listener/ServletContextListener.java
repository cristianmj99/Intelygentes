...
public class ServletContextListener implements javax.servlet.ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		try {
			...
			conn = DriverManager.getConnection("jdbc:db2://dashdb-txn-sbox-yp-lon02-07.services.eu-gb.bluemix.net:50000/BLUDB", "hwm67262", "0s-b9n57c3z8kblk");
            if (conn != null) {
